...
function showProducts_Prices() {
    ...
    let tax = 0;
    let subtotal = 0;
    DiscountAmount = parseInt($("#txtTotalDisccount").val());
   ...
   // $("#txtTotalDisccount").val(tax.toFixed(2))
    $("#txtTotal").val(total.toFixed(2) - DiscountAmount.toFixed(2))
...
$("#btnFinalizeSale").click(function () {
    ...
    const sale = {
        ...
        totalDiscount: $("#txtTotalDisccount").val(),
        total: $("#txtTotal").val(),
    ...
    fetch("/Sales/RegisterSale", {
        ...
        if (responseJson.state) {
            ...
            $("#linkPrint").attr("href", `/Sales/ShowPDFSale?saleNumber=${responseJson.object.saleNumber}`);
