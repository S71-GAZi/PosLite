    ...
    fetch("/Admin/GetSummary")
        .then(response => {
            ...
            if (responseJson.state) {
                ...
                //$("#monthlyProfites").text(d.profitLoss.monthlyProfites)
                //$("#yearlyProfites").text(d.profitLoss.yearlyProfites)
                //$("#totalProfites").text(d.profitLoss.totalProfites)
                formatProfitLoss("#monthlyProfites", d.profitLoss.monthlyProfites);
                formatProfitLoss("#yearlyProfites", d.profitLoss.yearlyProfites);
                formatProfitLoss("#totalProfites", d.profitLoss.totalProfites);
...
function formatProfitLoss(selector, value) {
    ...
    if (value < 0) {
        ...
        element.css("color", "green"); // or your default color
    }
}